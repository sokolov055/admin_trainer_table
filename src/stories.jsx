    ...
    frames: [
      {
        ...
        art: 'schedule',
        tint: '#8ec0f5',
        heading: 'Вся тренировка — в приложении',
        body: 'Откройте «Тренировки» и нажмите «Начать тренировку». Записывайте вес и повторы, отмечайте готовые подходы. Упражнения и подходы можно менять внутри занятия. Пауза и черновик помогут продолжить позже, а результат останется в журнале.',
      },
      {
        id: 'nutrition-pace',
        date: '19 сентября',
