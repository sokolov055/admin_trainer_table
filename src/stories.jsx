 ...
 *
 * ПРАВИЛО, КОТОРОЕ НЕ ОБСУЖДАЕТСЯ: каждая новая функция приложения едет
 ...
 *
 * Вместе с кадром поднимается номер в `caption`:
 *   обычная функция  — вторая цифра (1.1 → 1.2)
 *   большое обновление — первая (1.4 → 2.1)
 *
    ...
    frames: [
      {
        ...
        art: 'hide',
        tint: '#8ec0f5',
        heading: 'Лишние месяцы можно убрать',
        body: 'Листы с программами копятся годами, и в приложение уезжали '
          + 'все. Теперь ненужные месяцы скрываются — лист остаётся в '
          + 'таблице со всем содержимым, но клиент его не видит. Скрыть и '
          + 'вернуть можно и в таблице, и прямо из приложения.',
      },
      {
        id: 'nutrition-pace',
        date: '19 сентября',
