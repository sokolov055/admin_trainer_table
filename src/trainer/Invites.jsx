...
/**
 * Приглашение по общей ссылке: создать, разослать, отозвать.
 *
 * СЕЙЧАС НИГДЕ НЕ ПОКАЗЫВАЕТСЯ. Клиента заводят из его карточки —
 * персональной ссылкой (InviteLink.jsx), которая сразу открывает кабинет
 * без регистрации и почты. Общая ссылка вела на форму, где человек
 * регистрировался сам, и это была лишняя работа ради того же результата.
 *
 * Файл оставлен не по забывчивости: тем же механизмом заводятся ТРЕНЕРЫ,
 * и когда до них дойдут руки, вернуть экран — одна строка в TrainerApp.
 * Серверные действия и страница приёма приглашения (InviteRegistration.jsx)
 * работают: уже разосланные ссылки не должны перестать открываться.
 */
